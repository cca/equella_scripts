...
## Usage:
## ./arch-div-course-csv-to-taxo.pl course-list.csv > output.csv
## Then take output.csv & run through EQUELLA upload script

## IMPORTANT NOTE: script is specific to Architecture Division courses
## which have an extra node in the taxonomy tree (Program).
