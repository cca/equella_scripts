 ...
 */
 xml = "<xml><mods><origininfo><dateCreatedWrapper>REPLACE</dateCreatedWrapper></origininfo></mods></xml>";
...
url = stem + encodeURIComponent(xml).replace('REPLACE', '%3C' + el + '%3E${' + el + '}%3C%2F' + el + '%3E') + '&in=' + id + params;
