...
describe('Strict MODS Conversion', () => {
    ...
    describe('wrapLocationTextContent', () => {
        const locationTextFixtures = {
            ...
            physicalLocationInRelatedItem: `<xml><mods>
